...
return A.j(A.Kn(A.mk(a0.b,"_loadInfo").b),$async$cD)
case 3:b=a2
A.mk(a0.b,"_loadInfo")
o=new A.vx(A.QI([],t.ey))
n=t.f
m=n.a(B.Ct.pW(0,b,null))
l=J.U6(m)
k=l.q(m,"frames")
j=n.a(l.q(m,"meta"))
l=J.U6(j)
...
g.so5(32819)
break}}if(t.j.b(k))for(l=J.IT(k);l.V();){f=n.a(l.gP(l))
e=A.Bt(J.x9(f,"filename"))
d=A.nu("(.+?)(\\.[^.]*$|$)").ej(e).b[1]
d.toString
p.zl(o,i,d,f,j)}if(n.b(k))for(l=J.YE(k),d=J.IT(t.O.a(l.gv(k)));d.V();){c=d.gP(d)
f=n.a(l.q(k,c))
c=A.nu("(.+?)(\\.[^.]*$|$)").ej(c).b[1]
c.toString
p.zl(o,i,c,f,j)}q=o
